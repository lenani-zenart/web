...
Button.pixel_properties = ['font-size', '-webkit-border-radius','-moz-border-radius','border-radius', 'padding', 'padding-top', 'padding-right', 'padding-bottom', 'padding-left'];
